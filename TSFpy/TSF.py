...
def TSF_command_FizzBuzz():    #TSF_doc:TSF_about.tsfより小さなサンプルFizzBuzzプログラム。
    ...
    "FZcount:","0","#TSF_peekthe","[0]+1","#TSF_calcDC","FZcount:","0","#TSF_pokethe",
    "FZcount:","FZcount:","0","#TSF_peekthe","([0]#3Z1~0)+([0]#5Z2~0)","#TSF_calcDC","#TSF_peekthe","1","#TSF_echoes",
    "FZjunp:","FZcount:","0","#TSF_peekthe","[0]-20O1~0","#TSF_calcDC","#TSF_peekthe","#TSF_this",
    ]))
